...
const JobDetail = () => {
  ...
  if (loading) {
    return <p className="text-center py-6">Loading job details...</p>;
  }
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 shadow rounded-lg space-y-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {job.postedBy && (
          <div>
            ...
            <p className="text-gray-800">{job.postedBy}</p>
          </div>
        )}
        {job.location && (
          <div>
        ...
        {job.vacancies !== undefined && (
          <div>
            <h3 className="text-sm font-medium text-gray-500">Vacancies</h3>
            <p className="text-gray-800">{job.vacancies}</p>
          </div>
        )}
        {job.postingDate && (
          <div>
